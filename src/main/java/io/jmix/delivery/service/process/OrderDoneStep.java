...
@Component(value = "orderDoneStep")
public class OrderDoneStep extends AbstractTransactionalStep {

    protected OrderDoneStep(SystemAuthenticator systemAuthenticator,
