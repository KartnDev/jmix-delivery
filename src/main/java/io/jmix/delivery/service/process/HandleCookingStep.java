...
@Component(value = "handleCookingStep")
public class HandleCookingStep extends AbstractTransactionalStep {

    protected HandleCookingStep(SystemAuthenticator systemAuthenticator,
